...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YOUR-USERNAME/YOUR-REPO-NAME/blob/main/Hermes_Agent_Colab_Drive_Telegram_v3.ipynb)
...
- 💾 Persists config, `.env`, skills, and conversation memory in a `harmes agent` folder on **your Google Drive**, so nothing is lost when the Colab runtime resets
...
The setup notebook and files in this repo are released under the [MIT License](LICENSE). Hermes Agent itself is a separate project, MIT licensed by Nous Research.
